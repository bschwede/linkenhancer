...
/**
 * Wrapper class for LinkEnhancerModule in order to also show webtrees manual link on admin backend
 * 
 */
class LinkEnhancerModuleExt extends LinkEnhancerModule implements ModuleExtGlobalInterface {
